...
"}")
        ...
        self.btn_import_dicom_folder = QtWidgets.QPushButton(self.frame_2)
        self.btn_import_dicom_folder.setObjectName("btn_import_dicom_folder")
        ...
        self.btn_channel_tandem = QtWidgets.QPushButton(self.groupBox_5)
        self.btn_channel_tandem.setMinimumSize(QtCore.QSize(50, 0))
        self.btn_channel_tandem.setMaximumSize(QtCore.QSize(50, 16777215))
        self.btn_channel_tandem.setObjectName("btn_channel_tandem")
        ...
        self.tandem_tabbedWidget = QtWidgets.QTabWidget(self.page_4)
        self.tandem_tabbedWidget.setObjectName("tandem_tabbedWidget")
        self.tandem_tab_preloaded = QtWidgets.QWidget()
        self.tandem_tab_preloaded.setObjectName("tandem_tab_preloaded")
        self.verticalLayout_11 = QtWidgets.QVBoxLayout(self.tandem_tab_preloaded)
        self.verticalLayout_11.setObjectName("verticalLayout_11")
        self.listWidget_savedTandems = QtWidgets.QListWidget(self.tandem_tab_preloaded)
        ...
        self.groupbox_newTandem = QtWidgets.QGroupBox(self.tandem_tab_preloaded)
        ...
        self.tandem_tab_generated = QtWidgets.QWidget()
        self.tandem_tab_generated.setObjectName("tandem_tab_generated")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.groupBox_2.setTitle(_translate("MainWindow", "import folder"))
        self.btn_import_dicom_folder.setText(_translate("MainWindow", "import"))
        ...
        self.btn_channel_tandem.setText(_translate("MainWindow", "Tandem"))
        ...
        self.tandem_tabbedWidget.setTabText(self.tandem_tabbedWidget.indexOf(self.tandem_tab_preloaded), _translate("MainWindow", "PreLoaded Tandems"))
        self.tandem_tabbedWidget.setTabText(self.tandem_tabbedWidget.indexOf(self.tandem_tab_generated), _translate("MainWindow", "Generated"))
